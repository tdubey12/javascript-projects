...
function reverseCharacters (stringToReverse){
    ...
    return reversedStr ;
     ...
     let reversedStr =  String(stringToReverse);
...
function completeReversal(oldArray){
    ...
    for(let i=0;i<oldArray.length;i++){
        let reversedItem = reverseCharacters(oldArray[i]);
        newArray.push(reversedItem);
    }
...
console.log(` The area is ${areaOfRectangle(2,5)}`);
console.log(` The area is ${areaOfRectangle(2)}`);